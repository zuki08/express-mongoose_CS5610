...
console.log(
  'This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: node insert_sample_data "mongodb://127.0.0.1:27017/my_library_db"'
);
